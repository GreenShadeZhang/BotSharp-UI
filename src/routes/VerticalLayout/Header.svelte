<script>
	...
	import ProfileDropdown from '$lib/common/ProfileDropdown.svelte';	import { OverlayScrollbars } from 'overlayscrollbars';
	import { PUBLIC_LOGO_URL, PUBLIC_BRAND_NAME } from '$env/static/public';
	import { globalEventStore } from '$lib/helpers/store';
	import { GlobalEvent } from '$lib/helpers/enums';

	/** @type {any} */
	export let user;	/** @type {() => void} */
	...
	const toggleSideBar = () => {
		if (browser) {
			...
			document.body.classList.toggle('vertical-collpsed');			if (document.body.classList.contains('vertical-collpsed')) {
